...
public class FeastOfManyBeasts {
    ...
    public static boolean feast(String beast, String dish) {
        boolean firstLetterMatch = beast.substring(0,1).equalsIgnoreCase(dish.substring(0,1));
        boolean lastLetterMatch = beast.substring(beast.length()-1).equalsIgnoreCase(dish.substring(dish.length()-1));
